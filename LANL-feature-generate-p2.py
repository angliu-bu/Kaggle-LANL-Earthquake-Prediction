    ...
    def power_features(self, x, zc, y, seg_id):
        ...
        for w in windows:
            ...
            for autocorr_lag in autocorr_lags:
                feature_dict[f'power_autocorr_w{w}_lag{autocorr_lags}'] = feature_calculators.autocorrelation(powerseries, autocorr_lag)
                feature_dict[f'power_c3_w{w}_lag{autocorr_lags}'] = feature_calculators.c3(powerseries, autocorr_lag)
                feature_dict[f'powerratio_autocorr_w{w}_lag{autocorr_lags}'] = feature_calculators.autocorrelation(powerratioseries, autocorr_lag)
                feature_dict[f'powerratio_c3_w{w}_lag{autocorr_lags}'] = feature_calculators.c3(powerratioseries, autocorr_lag)
                
                feature_dict[f'real_autocorr_w{w}_lag{autocorr_lags}'] = feature_calculators.autocorrelation(realseries, autocorr_lag)
                feature_dict[f'real_c3_w{w}_lag{autocorr_lags}'] = feature_calculators.c3(realseries, autocorr_lag)
                feature_dict[f'realratio_autocorr_w{w}_lag{autocorr_lags}'] = feature_calculators.autocorrelation(realratioseries, autocorr_lag)
                feature_dict[f'realratio_c3_w{w}_lag{autocorr_lags}'] = feature_calculators.c3(realratioseries, autocorr_lag)
                
                feature_dict[f'imag_autocorr_w{w}_lag{autocorr_lags}'] = feature_calculators.autocorrelation(imagsseries, autocorr_lag)
                feature_dict[f'imag_c3_w{w}_lag{autocorr_lags}'] = feature_calculators.c3(imagsseries, autocorr_lag)
                feature_dict[f'imagratio_autocorr_w{w}_lag{autocorr_lags}'] = feature_calculators.autocorrelation(imagratiosseries, autocorr_lag)
                feature_dict[f'imagratio_c3_w{w}_lag{autocorr_lags}'] = feature_calculators.c3(imagratiosseries, autocorr_lag)
...
training_data.to_csv('training_data_part2.csv')
test_data.to_csv('test_data_part2.csv')
